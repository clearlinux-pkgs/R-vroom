...
Version  : 1.5.6
Release  : 4
URL      : https://cran.r-project.org/src/contrib/vroom_1.5.6.tar.gz
Source0  : https://cran.r-project.org/src/contrib/vroom_1.5.6.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636588650
