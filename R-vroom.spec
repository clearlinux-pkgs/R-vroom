...
Source0  : https://cran.r-project.org/src/contrib/vroom_1.6.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701832316
...
/usr/lib64/R/library/vroom/help/figures/lifecycle-superseded.svg
